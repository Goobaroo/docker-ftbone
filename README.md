# [FTB One](https://feed-the-beast.com/modpack/97-ftb_one) By FTB
...
The docker on first run will download the same version as tagged of `FTB One` and install it.  This can take a while as the Forge installer can take a bit to complete.  You can watch the logs and it will eventually finish.
...
* MOTD "FTB One Server Powered by Docker"
* LEVEL world
...
## Source
Github: https://github.com/Goobaroo/docker-ftbone

Docker: https://hub.docker.com/repository/docker/goobaroo/ftbone